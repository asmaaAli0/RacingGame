...
int playerx = 0, playery , playerH = 10;			  //player position(x, y) anh height
int enemyY1, enemyx2w ,enemyMove, enemyMove1;		//enemies position and movement
